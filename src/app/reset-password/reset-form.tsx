...
export function ResetPasswordForm({ initialError = "", ready = false }: { initialError?: string; ready?: boolean }) {
  return <AuthCard eyebrow="Pemulihan akses" title="Buat kata sandi baru" description="Gunakan kata sandi yang kuat dan berbeda dari kata sandi akun Anda yang lain.">
